...
if __name__ == "__main__" :
    ...
    while True :
        ...
        while True :
            ...
            # if (t1X <= -width/2) or (t2X <= -width/2) or (t3X <= -width/2) or \
            #     (t1X >= width/2) or (t2X >= width/2) or (t3X >= width/2) or \
            #     (t1Y >= height/2) or (t2Y >= height/2) or (t3Y >= height/2) or \
            #     (t1Y <= -height/2) or (t2Y <= -height/2) or (t3Y <= -height/2) :
            #         t1.goto(-100, -100); t2.goto(0, 0); t3.goto(100, 100)
